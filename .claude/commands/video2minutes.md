...
allowed-tools: Bash(python:*), Bash(source:*), Bash(cat:*), Bash(ls:*)
...
```bash
cd /Users/takueisaotome/PycharmProjects/video2minutes && source venv/bin/activate && python src/cli/video2minutes.py -i $ARGUMENTS
```
...
```bash
ls -t /Users/takueisaotome/PycharmProjects/video2minutes/transcript/*.txt 2>/dev/null | head -1 | xargs cat
```

### 2. 議事録

```bash
ls -t /Users/takueisaotome/PycharmProjects/video2minutes/minutes/*.md 2>/dev/null | head -1 | xargs cat
```
