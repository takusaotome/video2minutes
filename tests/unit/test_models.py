...
from app.models import (
    TaskStatus, ProcessingStepStatus, ProcessingStepName,
    ProcessingStep, MinutesTask, UploadResponse, TaskListResponse,
    TaskStatusResponse, TaskResultResponse, WebSocketMessage, ErrorResponse
)
...
class TestMinutesTask:
    ...
    def test_update_step_status_processing(self):
        ...
        # アップロードステップを処理中に設定
        task.update_step_status(ProcessingStepName.UPLOAD, ProcessingStepStatus.PROCESSING)
    ...
    def test_update_step_status_failed(self):
        ...
        error_msg = "テストエラー"
        task.update_step_status(ProcessingStepName.UPLOAD, ProcessingStepStatus.FAILED, error_message=error_msg)
    ...
    def test_partial_progress_calculation(self):
        ...
        # 部分的な進捗
        task.update_step_status(ProcessingStepName.UPLOAD, ProcessingStepStatus.COMPLETED, 100)
        task.update_step_status(ProcessingStepName.AUDIO_EXTRACTION, ProcessingStepStatus.PROCESSING, 50)
...
class TestResponseModels:
    ...
    def test_upload_response(self):
        ...
        assert response.message == "ファイルのアップロードが完了しました。処理を開始します。"
