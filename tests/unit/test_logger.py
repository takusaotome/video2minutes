...
from app.utils.logger import setup_logging, get_logger, LoggerMixin, JSONFormatter
...
class TestSetupLogging:
    ...
    def test_setup_logging_with_different_log_levels(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            for level in ["DEBUG", "INFO", "WARNING", "ERROR", "CRITICAL"]:
                ...
                logger = setup_logging(log_level=level, log_dir=log_dir, app_name="test")
    ...
    def test_setup_logging_log_file_naming(self, mock_datetime):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            expected_error_log_file = Path(temp_dir) / f"{app_name}_error_2024-01-01.log"
...
class TestLoggingErrorHandling:
    ...
    def test_json_formatter_handles_non_serializable_objects(self):
        ...
        try:
            ...
            pytest.fail("JSONFormatter should handle non-serializable objects gracefully")
