...
describe('FileUploader - Advanced Integration Test', () => {
  let pinia
  let toastService
  ...
  it('FileUploaderの高度なスタブテスト', async () => {
    ...
    // Toastメッセージの確認
    expect(testToast.add).toHaveBeenCalledWith(
